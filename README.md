#ใบงานที่ 4 เรื่อง 
การใช้งานคำสั่งเกี่ยวกับการแสดงผลบน Text Mode ขั้นพื้นฐานในภาษา C#
...
####บันทึกผลการทดลอง
จากการทดลองตามข้อที่1 โดยการพิมพ์คำว่า Console.Write(“Hello”); จะพบว่าเมื่อรันโค้ดดังกล่าวแล้วจะมีหน้าต่างพื้นหลังสีดำขึ้น แสดงคำว่า Hello press any key to continue . . . เมื่อทำการกดคีย์บอดตัวใดตัวหนึ่งการรันก็จะสิ้นสุดแล้วกลับมาหน้าโค้ดอีกครั้ง ดังภาพ
